...
export default class ParkingLotsMap extends React.Component {
  state = {
    errorMessage: false,
    location: true,
    loading: true,
        ...
        <View style={styles.container}>
          ...
          {this.state.tooltipVisible && (
            ...
            >
              ...
              />
              <Text>
                Select the location by holding and dragging the marker
              </Text>
            </View>
          )}
          ...
          {this.state.errorMessage ? (
            ...
            >
              <Text>Enable Location to Use This Feature</Text>
            </View>
          ) : this.state.loading ? (
            <View
              style={{
