        ...
        <View style={{flex:1,backgroundColor:Colors.white}} >
            ...
            <View style={{flex:2,backgroundColor:'#fff'}} >
                ...
                <View style={{flex:1,flexDirection:'column',justifyContent:'flex-start',alignItems:'center',backgroundColor:'#fff'}} >
                    ...
                    <Text style={{maxWidth:'50%', color:"#999",fontSize:14, textAlign:'center',paddingTop:10}} >An all in one parking app for your needs!</Text>
                </View>   

                {/* Button */}
                <View style={{flex:1,flexDirection:'column',justifyContent:'flex-end',alignItems:'center'}} >
                    {}
                    <Buttons btn_text={"Get Parking!"} on_press={()=>navigation.navigate("Login")} />
                </View>
            </View>
        </View>
    )
